...
print('=================================')
for publish in obj.find_all('div',class_='bungkus_txt_headline_center'):
    print(publish.find('h2').text)

print('\nMenyimpan headline pada file text')
print('===================================')
f=open('D:/proyek//headline.txt','w')
for publish in obj.find_all('div',class_='bungkus_txt_headline_center'):
    f.write(publish.find('h2').text)
    f.write('\n')
f.close()
...
now = datetime.now()
# Lokasi file json
f=open('D:/proyek//headline.json','w')
